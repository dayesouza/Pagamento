...
class TelaWeb {
  ...
  public function telaHome($parametros) {
    ...
    echo "<a id='pay' href=\"?page=PagamentoC.verificaNovaCompra\">Verificar</a>";
    echo "</body>";
    echo "<script>";
    echo " setTimeout(function(){ document.getElementById('pay').click(); }, 10000);";
    echo "</script>";
    if ($parametros != null) {
      echo "<p>" . $parametros["msg"] . "</p>";
    }
    echo "</html>";
  }
